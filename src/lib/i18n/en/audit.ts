...
export const audit = {
  ...
  log: {
    ...
    summary: {
      ...
      totalNote: 'Whole log, not filtered',
      latestDay: 'Events on {date}',
      latestDayNote: 'Latest day with activity · click to filter',
      latestDayNone: 'Events on the latest day',
      latestAt: 'Latest entry',
      latestAtNote: 'On {date}',
