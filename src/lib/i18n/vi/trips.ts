...
export const trips = {
  ...
  packages: {
    ...
    onlyFragile: 'Chỉ hàng dễ vỡ',
    /** Chip yêu cầu xếp của từng kiện, suy từ trường của kiện: "Dễ vỡ" là mức Cao, "Dễ vỡ vừa" là mức Trung bình. */
    req: {
      fragile: 'Dễ vỡ',
      fragileMedium: 'Dễ vỡ vừa',
      upright: 'Giữ đứng',
      noStack: 'Không xếp chồng',
      anyOrientation: 'Được xoay',
      more: '+{count}',
    },
    shown: '{shown} / {total} dòng · {instances} kiện đang hiện',
    units: 'Đơn vị: cm / kg',
    /** Cột phải khi chưa chọn kiện: kiện dễ vỡ (mức Cao) cần xem trước khi xếp. */
    fragileTitle: { one: '{count} kiện dễ vỡ', other: '{count} kiện dễ vỡ' },
    fragileNote: '{names}. Xem yêu cầu trước khi xếp.',
    /** Phần xem kiện ở đầu panel kiện (V2): hình theo kích thước và số của một kiện / cả dòng. */
    preview: {
      ...
      volumeEach: 'Thể tích mỗi kiện',
      liters: '{value} lít',
      requirements: 'Yêu cầu xếp hàng',
      fragility: 'Mức dễ vỡ: {level}',
      upright: 'Giữ đứng khi xếp',
      orientations: { one: '{count} hướng đặt được', other: '{count} hướng đặt được' },
      noStack: 'Không cho xếp chồng lên trên',
      maxTopLoad: 'Tải tối đa đặt lên trên: {weight} / kiện',
    },
  ...
  compare: {
    ...
    /** Ma trận so sánh (V2): dòng là chỉ số, cột là bản lưu, chọn bản bằng nút radio ở đầu cột. */
    matrixTitle: 'Đối chiếu bản lưu',
    matrixHint: 'Chọn một bản ở đầu cột để mở trong 3D. Không đánh dấu tốt nhất khi mọi bản bằng nhau.',
    metric: 'Chỉ số',
    onlyDifferences: 'Chỉ hiện khác biệt',
    noDifferences: 'Các bản giống nhau ở mọi chỉ số.',
    preview: 'Hình phương án',
    jobLabel: 'Mã job',
    lineageTitle: 'Bản duyệt kế thừa kết quả chạy',
    lineage: '{approved} được duyệt từ {source}.',
    lineageSame: 'Hai bản có cùng chỉ số chất xếp; chỉ khác thời điểm và trạng thái duyệt.',
