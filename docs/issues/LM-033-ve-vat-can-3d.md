...
- *(bổ sung sau báo cáo phase)* Xe seed `VEHICLE-002` (Hyundai HD210) có hai hốc bánh không chịu tải 110 × 25 × 32 cm ở x = 420, sát hai vách: Planner mặc định nay có vật cản thật. Mock optimization vẫn xếp đủ 132/132, revision đã duyệt vẫn không có issue (test seed xanh).
